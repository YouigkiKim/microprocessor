...
void activateAlarm(){
  if(alarmcurrent - actstartTime < 1500){  // 현재 시간 기록 8000 ){
    tone(buzzerPin, 800); 
  }
  else if(alarmcurrent - actstartTime < 3000){
    noTone(buzzerPin); 
  }
  else if(alarmcurrent - actstartTime < 4500){
    tone(buzzerPin, 1000); 
  }
  else if(alarmcurrent - actstartTime < 6000){
    noTone(buzzerPin); 
  }
  else if(alarmcurrent - actstartTime < 7500){
    tone(buzzerPin, 1000); 
  }
  else if(alarmcurrent - actstartTime < 8000){
    noTone(buzzerPin); 
  }
  else if(alarmcurrent - actstartTime < 10000){
    tone(buzzerPin, 1000); 
  }
  else{
    noTone(buzzerPin);
